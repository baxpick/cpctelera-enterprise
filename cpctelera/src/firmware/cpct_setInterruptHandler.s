...
;; code saves registers on the stack (AF, BC, DE, HL, IX and IY) and restores them after
...
;; the function. You can use <cpct_setInterruptHandler_allRegisters> if you want to
;; save all registers (standard and alternate).
;;
;; Destroyed Register values:
;;    A, HL
;;
;; Required memory:
;;    39 bytes (17 bytes function + 22 bytes for safe interrupt wrapper code)
;;
;; Time Measures:
